...
export default function CustomAIPage() {
  ...
  const handleCreateModel = async () => {
    if (!user || !db || !newModelName.trim() || selectedRepos.length === 0)
      return;
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-muted-foreground mt-2">
                  Train AI assistants on specific repositories for personalized
                  coding help
                </p>
              </div>
              <Dialog
              ...
              >
                ...
                <DialogContent className="max-w-2xl">
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Train an AI assistant on selected repositories. The model
                      will have deep knowledge of the chosen codebases.
                    </DialogDescription>
                  </DialogHeader>
                  ...
                  <DialogFooter>
                    ...
                    <Button
                      ...
                      disabled={
                        !newModelName.trim() || selectedRepos.length === 0
                      }
                    >
                      Create Model
                    </Button>
            ...
            {models.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-muted-foreground mb-4">
                  Create your first AI model trained on specific repositories
                  for personalized coding assistance.
                </p>
